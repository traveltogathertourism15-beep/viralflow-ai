...
# Website ki setting (White background aur asaan design)
...
if st.button("Generate Script"):
    if not api_key:
        ...
        try:
            ...
            # AI ko batana ke kaise likhna hai
            prompt = f"Write a viral social media script in {lang} about this topic: {topic}. Include a strong hook and call to action."
